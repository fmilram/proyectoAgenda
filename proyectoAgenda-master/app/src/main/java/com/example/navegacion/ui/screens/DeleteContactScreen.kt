package com.example.navegacion.ui.screens.delete
...
fun DeleteContactScreen(
            ...
            LazyColumn(
                ...
                itemsIndexed(contacts) { index, contact ->
                    ContactItemCard(
                        contact = contact,
                        index = index,
                        onEdit = {},  // En DeleteScreen no editamos
    ...
    // Mostrar diálogo de confirmación si se seleccionó un contacto para borrar
